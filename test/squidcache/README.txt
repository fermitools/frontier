...
1. A program which uses DCOracle to access the database to create a list of tables and valid QUDs for each
2. An archived version of the list from step 1, in python piclke format (*.pkl file). the one Used in the test was cdf_cid_table_list_1.pkl
