...
public class Servicer {
    ...
    private static final String sql_pescalib =
        "select address,gain,sourcemean,sourcerms,sourcenorm,lasernorm,linearity1,linearity2,"
        + "linearity3,attenuation1,attenuation2,attenuation3 from pescalib where cid = ? ";
