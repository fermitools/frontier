 ...
 * Modified from Linux kernel 2.6.7 md5.c file by Sergey Kosyakov
 * 
...
#else
#define le_2_i32(p) (*((int*)(p)))
#define i32_2_le(p) (*((int*)(p)))
#define le32_to_cpu_array(a,b) do{} while(0)
#define cpu_to_le32_array(a,b) do{} while(0)
